...
public class HealthBar_UI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        myStats.onHealtheChanged += UpdateHealthUI; // 체력 변경 시 UI 업데이트
    ...
    {
        slider.maxValue = myStats.GetMaxHealth();  // 최대 체력 설정
    ...
    private void OnDisable()
    {
        ...
        myStats.onHealtheChanged -= UpdateHealthUI; // 체력 변경 시 UI 업데이트 해제
    }
